    ...
    while not open_set.empty():
        ...
        for neighbor in get_neighbors(current):
            ...
            if temp_g < g_score[neighbor]:
                ...
                f_score[neighbor] = temp_g + h(neighbor, end_cell)
...
tk.Button(btn_frame, text="Ejecutar A*", command=run_a_star).pack(side="left", padx=5)
tk.Button(btn_frame, text="Ejecutar Dijkstra", command=run_dijkstra).pack(side="left", padx=5)
tk.Button(btn_frame, text="Ejecutar BFS", command=run_bfs).pack(side="left", padx=5)
tk.Button(btn_frame, text="Reiniciar", command=reset_grid).pack(side="left", padx=5)
